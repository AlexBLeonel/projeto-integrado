...
<div class="container-fluid row justify-content-around">
    ...
    <div class="card text-center" style="width: 18rem;">
        ...
        <div class="card-body">
            <h4>Reservas</h4>
            <a type="button" href="{{ route('booking.create') }}" class="btn btn-sm btn-outline-primary m-1"><i class="fas fa-plus p-1"></i> Adicionar</a>
            <a type="button" href="{{ route('booking.list') }}" class="btn btn-sm btn-outline-primary m-1"><i class="fas fa-clipboard-list"></i></i> Listar</a>
        </div>
    </div>
    ...
    <div class="card text-center" style="width: 18rem;">
        ...
        <div class="card-body">
            <h4>TAGs</h4>
            <a type="button" href="#" class="btn btn-sm btn-outline-primary m-1"><i class="fas fa-plus p-1"></i>  Adicionar</a>
            <a type="button" href="#" class="btn btn-sm btn-outline-primary m-1"><i class="fas fa-clipboard-list"></i> Listar</a>
        </div>
    </div>
