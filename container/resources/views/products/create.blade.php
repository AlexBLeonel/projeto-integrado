...
<div class="container-fluid">
    ...
    <form action="{{ route('products.store') }}" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input name="description" type="text" id="description" class="custom-select-sm form-control @error('description') is-invalid @enderror" placeholder="Informe a Descrição..." required autocomplete="description" autofocus>
                @error('description')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input name="price" type="text" id="price" class="custom-select-sm form-control @error('price') is-invalid @enderror" placeholder="Informe o Preço..." required autocomplete="price" autofocus>
                @error('price')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
